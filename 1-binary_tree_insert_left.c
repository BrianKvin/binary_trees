 ...
 */
// This function takes two parameters; 'value' to store the new node
// and 'parent' a pointer to the node to insert the left child in
binary_tree_t *binary_tree_insert_left(binary_tree_t *parent, int value)
{
	...
	// the old left child is set to the new node
